...
type Store interface {
	...
	Update(ctx context.Context, newValue any, id manifest.VersionedResourceID) (exists bool, err error)
	...
	RemoveLinked(ctx context.Context, model any, link string, owner any) error
